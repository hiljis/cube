...
// import { selectIsSolid } from '../../../../store/cube/cubeSlice';
...
// 				<StyledCubeIconFilled height={30} color="black" hovercolor="black" />
// 			</SelectionShape>
// 			<SelectionShape id={SELECTION_NOT_SOLID} isSolid={isSolid}>
// 				<StyledCubeIconOutlined height={30} color="black" hovercolor="black" />
// 			</SelectionShape>
